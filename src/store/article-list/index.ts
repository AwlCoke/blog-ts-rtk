   ...
   initialState,
    reducers: {
       articlesRequested: (state: ArticleListModel ) => {
        ...
        articlesLoaded: (state: ArticleListModel, action: PayloadAction<{ articles: ArticleModel[], articlesCount: number }>) => {
...
export const { articlesRequested, articlesLoaded, articlesErrors, favoritedArticle, setCurrentArticle, setCurrentPage } = index.actions;
